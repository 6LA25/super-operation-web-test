<template>
  <v-container class="pa-md-4 pa-sm-3 pa-2" fluid>
    <v-row justify="center" no-gutters>
      ...
      <v-col cols="12" md="10" class="mb-md-4 mb-sm-3 mb-2">
        <p>然后在 <code>.vue</code> 文件使用它；本来是想全局安装的，但是并没有生效，知道怎么全局声明的小伙伴可以告诉我
      ...
      <v-col cols="12" md="10" class="mb-md-4 mb-sm-3 mb-2">
        <p>prism 支持的语言种类太多了，有很多是你不会使用到的，推荐你使用 Babel 插件 <code>babel-plugin-prismjs</code> 管理 prismjs，你可以随意的选择加载需要使用的语言
        </p>
      ...
      <v-col cols="12" md="10" class="mb-md-4 mb-sm-3 mb-2">
        <p>完成以上步骤，接下来你可以在HTML中愉快的使用代码块了，vuetify 自己处理过 <code>&lt;code&gt;</code> 标签，代码块会有阴影和第一行会有一点点的缩进，如果你介意的话，可以加入以下样式
        </p>
